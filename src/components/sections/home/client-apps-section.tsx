...
const clientApps = [
  {
    name: "Observa",
    description: "Advanced analytics and monitoring solution for Shopify stores. Track performance, monitor key metrics, and gain insights to optimize your business.",
    category: "Analytics",
    rating: 5.0,
    installs: "100+",
    features: ["Real-time Analytics", "Performance Monitoring", "Custom Reports", "Data Insights"],
    link: "https://apps.shopify.com/observa?search_id=af7725a7-1328-45d9-812c-d37b4b6e2e1e&surface_detail=Observa&surface_inter_position=1&surface_intra_position=1&surface_type=search",
    client: "Enterprise Client"
  },
  {
    name: "Dashi Security Suite",
    description: "Comprehensive security solution for Shopify stores. Protect your store from threats, monitor security events, and ensure customer data safety.",
    category: "Security",
    rating: 5.0,
    installs: "500+",
    features: ["Threat Detection", "Security Monitoring", "Data Protection", "Compliance Tools"],
    link: "https://apps.shopify.com/dashi-security-suite?st_source=autocomplete&surface_detail=autocomplete_apps",
    client: "Security-focused Client"
  }
];

export default function ClientAppsSection() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <InView>
          ...
          >
            {clientApps.map((app, index) => (
              <div key={index} className="group max-w-md">
        ...
        <InView>
          <div className="text-center mt-16">
            ...
            >
              Need a custom Shopify app for your business? We can help bring your vision to life.
            </TextEffect>
